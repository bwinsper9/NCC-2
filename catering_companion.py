...
try:
    recipes_df = pd.read_csv('master_recipe_template_final_final.csv')
    ...
    st.error("Master recipe file not found. Please make sure 'master_recipe_template_final_final.csv' is placed in the same folder as this app.")
